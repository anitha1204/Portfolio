...
//             const imgData = canvas.toDataURL('image/png'); // Get the image data as base64
//             const pdf = new jsPDF('p', 'mm', 'a4');
//             const pdfWidth = pdf.internal.pageSize.getWidth();
//             const pdfHeight = pdf.internal.pageSize.getHeight();
//             const imgWidth = canvas.width;
//             const imgHeight = canvas.height;
//             const ratio = Math.min(pdfWidth / imgWidth, pdfHeight / imgHeight); // Maintain aspect ratio
//             const imgX = (pdfWidth - imgWidth * ratio) / 2; // Center the image horizontally
//             const imgY = 10; // Adjust top margin
...
//     return (
//         <>
//         <div className="max-w-4xl mx-auto p-8 bg-white" ref={pdfRef}>
//             {/* Header */}
...
//                         <ul className=" list-inside text-sm mt-2 space-y-2">
//                             <li> A comprehensive program in the science of baking and pastry art, this foundation course across 350+ hours, 2
//                                 months is under the direction supervision of Chef Deepali Sawant. This course is industry recognised through
//                                 certification by City & Guilds, London</li>
//                             <li>Technologies Used : MongoDB, Express.js, React.js, Node.js, Tailwind css, Nodemailer.</li>
//                         </ul>
//                     </div>
//                     <div>
//                         <p className="text-md italic text-blue-500 font-semibold"> Self Projects: Resume, Portfolio</p>
//                         <ul className=" list-inside text-sm mt-2 space-y-2">
//                             <li> Completed various projects using HTML, CSS, JavaScript, ReactJs, NodeJs, and ExpressJs, featuring CRUD operations
//                                 and responsive design across all devices, including mobile, desktop, and iPad. These projects are showcased in my
//                                 portfolio.</li>
